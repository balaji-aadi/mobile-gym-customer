...
const NavBar = () => {
  ...
  return (
    <>
      <nav className="bg-gradient-to-r from-primary to-primary-dark text-white px-4 sm:px-6 py-3 shadow-lg sticky top-0 z-50">
              ...
              {user ? (
                <>
                  ...
                  {userMenuItems.map((item) => (
                    <Link
                      ...
                      to={item.path}
                      onClick={() => setMobileMenuOpen(false)}
                      className="block px-4 py-3 text-white/90 hover:text-white hover:bg-white/10 rounded-xl text-lg font-medium"
                    >
                      {item.label}
                    </Link>
                  ))}
                ...
                <div className="flex flex-col gap-3 pt-2">
                  <Link
                    to="/login"
                    onClick={() => setMobileMenuOpen(false)}
                    className="px-6 py-3 text-center bg-white/10 hover:bg-white/20 text-white rounded-xl text-lg font-medium"
                  >
                    Login
                  </Link>
                  <Link
