...
export const CategoryApi = {
  ...
  getAllSessionByCategoryId: (categoryId) => Api.get(`master/get-session-by-category-id/${categoryId}`),
  ...
  getSubscriptionBySessionId: (id) => Api.get(`subscription/get-subscriptions-by-session/${id}`),
