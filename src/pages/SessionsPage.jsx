  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Find and book your perfect workout session</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredSessions.map(session => (
          <div key={session.id} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:scale-105">
            {/* Image */}
            ...
            <div className="p-6">
              ...
              <p className="text-sm text-gray-500 mb-4">{session.subcategory} • {session.equipment}</p>
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-1">
                  ...
                  <span className={`text-sm font-medium ${getAvailabilityColor(session.spots, session.maxSpots)}`}>
              ...
              <div className="w-full bg-gray-200 rounded-full h-2 mb-4">
                <div
                  ...
                  style={{ width: `${((session.maxSpots - session.spots) / session.maxSpots) * 100}%` }}
                ></div>
              </div>
