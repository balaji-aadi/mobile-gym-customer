...
import { MapPin, Navigation, Clock, Phone, Star, Filter, Search } from 'lucide-react';
...
const LocationPage = () => {
  ...
  const locations = [
    ...
    },
    {
      ...
      rating: 4.5,
      amenities: ['24/7 Access', 'Premium Equipment', 'Personal Training', 'Spa'],
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Gym Locations</h1>
        <p className="text-gray-600">Find mobile gyms and fitness centers near you</p>
      </div>
            ...
            {filteredLocations.map(location => (
              <div
                ...
                className={`bg-white rounded-lg shadow-sm border-2 cursor-pointer transition-all hover:shadow-md ${
                  selectedLocation?.id === location.id ? 'border-primary-500' : 'border-gray-200'
                }`}
              >
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <div className="flex items-center space-x-4">
                      <div className="flex items-center space-x-1">
                        ...
                        <span className="text-gray-600">{location.nextAvailable}</span>
                      </div>
                      <div className="flex items-center space-x-1">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            <div className="h-96 bg-gradient-to-br from-blue-100 to-green-100 flex items-center justify-center relative">
              <div className="text-center">
                ...
                <p className="text-gray-500">Real-time location tracking would be displayed here</p>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
              <div className="relative h-48">
                ...
                <div className="absolute top-4 right-4">
                  <span className={`px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(selectedLocation.status)}`}>
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <p className="text-gray-600">{selectedLocation.nextAvailable}</p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="flex items-center space-x-2 mb-1">
          ...
          {!selectedLocation && (
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 text-center">
              ...
              <p className="text-gray-500">Choose a gym location from the list to view details and get directions</p>
            </div>
          )}
        </div>
      </div>
